...
return [
    ...
    |
    */
    'client_id' => env('PASSPORT_CLIENT_ID', SECRET_MANAGER_DATA['PASSPORT_CLIENT_ID']??'2'),
    /*
    |--------------------------------------------------------------------------
    | Client secret
    |--------------------------------------------------------------------------
    ...
    |
    */
    'client_secret' => env('PASSPORT_CLIENT_SECRET', SECRET_MANAGER_DATA['PASSPORT_CLIENT_SECRET']??null),
    /*
    |--------------------------------------------------------------------------
    | GraphQL schema
    |--------------------------------------------------------------------------
