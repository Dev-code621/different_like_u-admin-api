...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;text-align:center; @import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap'); font-family: 'Poppins', sans-serif;">
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="text-align: left; color:#6E8791; font-size:15px;line-height:24px; margin-top:30px; font-family: 'Poppins', sans-serif;">Viewpoints on this interaction may differ.  We encourage you to carefully consider the customer's perspective when crafting your response. Use this opportunity to regain their trust. </p>
                                        <h2 style="text-align: center; font-family: 'Poppins', sans-serif; font-weight:700; font-size: 22px; color:#023252;line-height: 24px;margin-top: 30px;">After 24 hours, negative reviews will appear on your business page.</h2>
                                        <p style="text-align: center; color:#6E8791; font-size:15px;line-height:24px; margin-top:30px; font-family: 'Poppins', sans-serif;">Sacki provides you with more information about your customers to better serve and expand your customer base. </p>
